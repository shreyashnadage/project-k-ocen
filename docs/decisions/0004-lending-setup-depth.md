# ADR 0004: Frappe Lending's real setup depth, and where this session stopped

**Status:** Accepted (documents a finding + a scope boundary, not a reversible decision)
**Date:** 2026-09-03
